      ...
      {availableAcademies.length === 0 ? (
        ...
        <div className="space-y-3">
          {availableAcademies.map(a => (
            <div
              key={a.id}
              className={`bg-white dark:bg-slate-800 rounded-2xl border p-3 sm:p-5 transition-colors ${
                ...
                <div className="flex items-center gap-2 shrink-0">
                  {a.role === 'director' && (
                    <Link
                      ...
                      className="inline-flex min-h-[40px] items-center justify-center sm:min-h-0 px-3 py-1.5 text-xs bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-300 rounded-lg hover:bg-slate-200 dark:hover:bg-slate-600 transition-colors"
                    >
                  ...
                  {activeAcademyId !== a.id && (
                    <button
                      ...
                      className="inline-flex min-h-[40px] items-center justify-center sm:min-h-0 px-3 py-1.5 text-xs bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors"
                    >
                      {t.academy.activate}
                    </button>
                  )}
