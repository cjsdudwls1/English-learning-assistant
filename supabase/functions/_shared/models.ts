export const MODEL_SEQUENCE = [
    ...
    'gemini-3.6-flash',            // Gemini 3.6 Flash (GA, 2026-07-21)
    'gemini-3.5-flash-lite',       // Gemini 3.5 Flash-Lite (GA, 2026-07-21)
...
export const MODEL_RETRY_POLICY: Record<(typeof MODEL_SEQUENCE)[number], { maxRetries: number; baseDelayMs: number }> = {
    ...
    'gemini-3.6-flash': { maxRetries: 1, baseDelayMs: 3000 },
    'gemini-3.5-flash-lite': { maxRetries: 1, baseDelayMs: 3000 },
