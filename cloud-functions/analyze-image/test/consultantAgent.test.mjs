 ...
 * 상한 8에 정확히 닿았다 — profile.get / (drilldown+samples.wrong)×3 / final 로 8/8을 쓰고
 * stats.timeseries는 한 번도 안 썼다. 자리가 없어서였는지 안 골라서였는지는 트레이스로
 * 구분되지 않는다. 상한이 조사량보다 크면 그 구분이 필요 없어진다.
 *
