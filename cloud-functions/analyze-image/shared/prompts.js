...
## ⚠️ EXCEPTION — multi-answer questions (복수정답: "모두 고르시오", "정답 2개" 등)
If the question instruction explicitly states the student must mark MULTIPLE correct choices (e.g. "모두 고르시오", "정답이 2개입니다", "select all that apply"), report ALL marked choice numbers separated by a comma and space, sorted ascending (e.g. "2, 4") — keep scanning after the first mark you find. For every OTHER (ordinary single-answer) question, ignore this section entirely and return exactly ONE digit as instructed below.
...
- ⚠️ EXCEPTION — multi-answer questions (복수정답: "모두 고르시오", "정답 2개" 등): if the question instruction explicitly states there are MULTIPLE correct choices, return ALL correct choice numbers separated by a comma and space, sorted ascending (e.g. "2, 4") — do NOT stop at one. For every OTHER (ordinary single-answer) question, ignore this and return exactly ONE digit as instructed above.
...
- ⚠️ Multi-answer questions (the instruction explicitly says to pick MULTIPLE correct choices, e.g. "모두 고르시오", "정답 2개", "select all that apply"): report ALL applicable choice numbers for BOTH user_answer and correct_answer, separated by a comma and space, sorted ascending (e.g. "2, 4"). For every OTHER (ordinary single-answer) question, ignore this and report exactly ONE digit as above.
